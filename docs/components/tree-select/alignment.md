...
- 发布：根导出、`@aifuxi/semi-ui-vue/tree-select`、default/named 导出契约（单元用例从 `./index` 固定）、`@aifuxi/semi-theme-default/tree-select.css`、类型、SSR import、tree-shaking、许可/SBOM、真实 tarball consumer。
