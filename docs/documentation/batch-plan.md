...
| 严格视觉与行为验收 | 0/859 当前有效 | 332 项待恢复；527 项未验收 | 恢复历史；新增 Table 第 16–30 项 |
...
2026-09-13 正式验收工具增加前置审阅门禁与失败即停，44 批旧报告因工具输入变化待重验，报告及旧指纹原样保留；历史累计通过仍为332项，尚未验收527项。新门禁同时发现 Divider、Notification、Popconfirm、Toast 缺少章节/API/迁移审阅，恢复前先完成语义复核。工具维护本身不重跑历史矩阵，下一轮统一安排实际失效恢复与新增范围，见[改进记录](../../ai-work/20260913-074247-documentation-acceptance-guardrails.md)。下文历次通过数字保留当时事实。
