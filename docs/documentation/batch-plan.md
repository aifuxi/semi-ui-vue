...
| 工作线             | 当前进度        | 剩余范围                                       | 下一批                                         |
| ------------------ | --------------- | ---------------------------------------------- | ---------------------------------------------- |
| 双语示例补齐       | 857/859 已映射  | 2 项待映射                                    | AIComponent 2 项            |
| 严格视觉与行为验收 | 43/859 有效验收 | 814 项已映射待验收，另有 2 项待补齐后进入验收 | Divider 2 项，然后 FloatButton 7 项、Grid 7 项 |
...
初始 163 项中，Icon 8 项、ConfigProvider 3 项、Locale 3 项、Dark Mode 2 项、Navigation 10 项已完成双语映射与严格验收；OverflowList 4 项、ScrollList 1 项、Transfer 14 项、Feedback 7 项、Notification 8 项、Toast 9 项、UserGuide 8 项、DragMove 4 项和 HotKeys 5 项已完成补齐线检查，严格验收待办仍保留，见 [OverflowList 记录](../../ai-work/20260907-103119-overflow-list-documentation-content.md)、[ScrollList 记录](../../ai-work/20260907-110551-scroll-list-documentation-content.md)、[Transfer 记录](../../ai-work/20260907-113702-transfer-documentation-content.md)、[Feedback 记录](../../ai-work/20260907-161013-feedback-documentation-content.md)、[Notification 记录](../../ai-work/20260907-185102-notification-documentation-content.md)、[Toast 记录](../../ai-work/20260907-212444-toast-documentation-content.md)与 [UserGuide / DragMove / HotKeys 记录](../../ai-work/20260907-222000-user-guide-drag-move-hot-keys-documentation.md)。以下保留原队列，跳过已补齐条目。从 AIComponent 开始继续补齐，无需等待本批严格验收后再推进下一批。
...
| AI 组件（AIChatDialogue、AIChatInput、Sidebar）                                                         |   34 |
