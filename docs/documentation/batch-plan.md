...
Button 17 项试点已建立独立、可追溯且随源码变化失效的验收流程。此前七批有效证据由 2026-09-11 的 240 项正式矩阵确认；FloatButton 新增 56 项正式矩阵通过，当前八批均有效；只有正式验收成功才能增加 `accepted`。
