...
// Reuse the pinned locale so default consumers receive the complete public field set.
export const DEFAULT_CONFIG_LOCALE = pinnedLocale_zh_CN as Readonly<SemiLocale>;
