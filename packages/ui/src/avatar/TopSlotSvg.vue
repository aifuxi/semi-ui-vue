...
defineOptions({ name: 'AvatarTopSlotSvg' });
defineProps<{ gradientStart: string; gradientEnd: string }>();
const gradientId = `semi-avatar-gradient-${useId().replace(/[^a-zA-Z0-9_-]/g, '')}`;
</script>
