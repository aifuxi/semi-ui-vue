...
function renderSvg(props: IconSvgProps): VNode {
  return h(
    ...
    [
      h('rect', { width: 22, height: 18, rx: 2, fill: '#F9FCFF' }, undefined),
      h(
        'path',
        {
          'fill-rule': 'evenodd',
      ...
      h('path', { d: 'M14.5 5c-2 0-4 .36-4 4 0 3.5-1.5 5-4 5', stroke: '#AEB2BE' }, undefined),
      h('rect', { x: 14, y: 4, width: 2, height: 2, fill: '#F77C93' }, undefined),
      h('rect', { x: 6, y: 13, width: 2, height: 2, fill: '#F8CE27' }, undefined),
      h(
        'path',
        {
...
export default convertIcon(renderSvg, 'lottie');
