...
function renderSvg(props: IconSvgProps): VNode {
  return h(
    ...
    [
      ...
      h('path', { d: 'M15 4h5a3 3 0 0 1 3 3v10a3 3 0 0 1-3 3h-5V4Z', fill: '#4CC3FA' }, undefined),
      h('path', { d: 'm19 7.5 2 3h-4l2-3Z', fill: 'white' }, undefined),
      h('path', { d: 'm19 16.5-2-3h4l-2 3Z', fill: 'white' }, undefined),
      h(
        'path',
        {
...
export default convertIcon(renderSvg, 'input-number');
