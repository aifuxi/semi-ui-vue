  ...
  return h(
    ...
    [
      h(
        'path',
        {
          d: 'M19 2H5a3 3 0 0 0-3 3v14a3 3 0 0 0 3 3h14a3 3 0 0 0 3-3V5a3 3 0 0 0-3-3Z',
          fill: '#4CC3FA',
        },
        undefined,
      ),
      ...
      h(
        'path',
        {
          d: 'M12 16.94c.5 0 .92-.42.93-.94a.95.95 0 0 0-.94-.93.93.93 0 1 0 0 1.87Z',
          fill: 'white',
        },
        undefined,
      ),
...
export default convertIcon(renderSvg, 'version-two');
