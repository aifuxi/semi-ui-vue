...
function renderSvg(props: IllustrationSvgProps): VNode {
  return h(
    ...
    [
      ...
      h(
        'circle',
        { cx: 58.9751, cy: 35.8643, r: 9.4443, fill: 'white', stroke: '#41464C' },
        undefined,
      ),
      h(
        'path',
        { d: 'M53.35 33.11c.3.58 1.13 1.56 2.17.87 1.03-.7.43-2.02 0-2.6', stroke: '#41464C' },
        undefined,
      ),
      h(
        'path',
        { d: 'M58.54 29.81c.3.58.98 1.26 2.16.87 1.3-.44.87-1.73.44-2.17', stroke: '#41464C' },
        undefined,
      ),
      h('path', { d: 'M62.87 34.41c.72-2.74 3.8-8.73 10.37-10.8', stroke: '#41464C' }, undefined),
      h(
        'path',
        { d: 'M73.24 23.6c1.16.87 5.8 2.42 5.2 0-.44-1.73-3.9-1.3-5.2 0Z', stroke: '#41464C' },
        undefined,
      ),
      h(
        'path',
      ...
      h('mask', { id: 'path-19-inside-1', fill: 'white' }, [
        h(
          'path',
          {
            'fill-rule': 'evenodd',
      ...
      h('circle', { cx: 46.6718, cy: 116.34, r: 4.37976, fill: '#E6E8EA' }, undefined),
      h('circle', { cx: 52.1318, cy: 115.26, r: 1.08003, fill: '#E6E8EA' }, undefined),
    ],
  );
}

export default convertIllustration(renderSvg, 'IllustrationIdle');
