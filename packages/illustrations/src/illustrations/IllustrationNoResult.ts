...
function renderSvg(props: IllustrationSvgProps): VNode {
  return h(
    ...
    [
      ...
      h(
        'circle',
        { cx: 45.5788, cy: 38.675, r: 33.1711, fill: 'var(--semi-color-primary-light-default)' },
        undefined,
      ),
      h(
        'path',
      ...
      h(
        'path',
        { d: 'M71.03 48.99c5.25 1.23 16.12 6.4 17.61 17.15', stroke: '#515151' },
        undefined,
      ),
      h(
        'path',
...
export default convertIllustration(renderSvg, 'IllustrationNoResult');
