...
function renderSvg(props: IllustrationSvgProps): VNode {
  return h(
    ...
    [
      ...
      h(
        'rect',
        { x: 67.706, y: 73.871, width: 55.6333, height: 39.8004, fill: 'white', stroke: '#515151' },
        undefined,
      ),
      h(
        'path',
      ...
      h(
        'path',
        { d: 'M63.82 83.33c-4.52-1.84-13.53-7.96-13.38-17.79', stroke: '#515151' },
        undefined,
      ),
      h(
        'path',
      ...
      h('mask', { id: 'path-16-inside-1', fill: 'white' }, [
        h(
          'path',
          {
            'fill-rule': 'evenodd',
      ...
      h('path', { d: 'M147.22 155.65c-.1 3.58 1.27 4.88 4.7 6.08', stroke: '#515151' }, undefined),
    ],
  );
}

export default convertIllustration(renderSvg, 'IllustrationNoContent');
