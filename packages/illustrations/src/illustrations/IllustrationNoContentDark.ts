...
function renderSvg(props: IllustrationSvgProps): VNode {
  return h(
    ...
    [
      ...
      h(
        'path',
        { d: 'M63.82 83.33C59.3 81.5 50.3 75.37 50.44 65.54', stroke: '#1C1F23' },
        undefined,
      ),
      h(
        'path',
      ...
      h('path', { d: 'M147.22 155.65c-.1 3.58 1.27 4.88 4.7 6.08', stroke: '#1C1F23' }, undefined),
    ],
  );
}

export default convertIllustration(renderSvg, 'IllustrationNoContentDark');
