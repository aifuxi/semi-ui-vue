...
export const REFERENCE_SOURCE_PATHS = Object.freeze({
  ...
  jsonViewerPublicEntry: 'vendor/semi-design/packages/semi-ui/jsonViewer/index.tsx',
  jsonViewerCoreEntry: 'vendor/semi-design/packages/semi-json-viewer-core/src/index.ts',
  jsonViewerWorkerEntry:
    'vendor/semi-design/packages/semi-json-viewer-core/src/worker/json.worker.ts',
  jsonViewerFoundation: 'vendor/semi-design/packages/semi-foundation/jsonViewer/foundation.ts',
  jsonViewerFoundationStyle:
    'vendor/semi-design/packages/semi-foundation/jsonViewer/jsonViewer.scss',
  jsonViewerDocumentation: 'vendor/semi-design/content/plus/jsonviewer/index.md',
  aiChatInputPublicEntry: 'vendor/semi-design/packages/semi-ui/aiChatInput/index.tsx',
  aiChatInputEditorEntry: 'vendor/semi-design/packages/semi-ui/aiChatInput/richTextInput.tsx',
  aiChatInputFoundation: 'vendor/semi-design/packages/semi-foundation/aiChatInput/foundation.ts',
  ...
  chatFoundation: 'vendor/semi-design/packages/semi-foundation/chat/foundation.ts',
  ...
  sidebarFileEntry: 'vendor/semi-design/packages/semi-ui/sideBar/widget/file.tsx',
  sidebarFoundation: 'vendor/semi-design/packages/semi-foundation/sidebar/containerFoundation.ts',
  sidebarFoundationStyle: 'vendor/semi-design/packages/semi-foundation/sidebar/sidebar.scss',
  sidebarDocumentation: 'vendor/semi-design/content/ai/sidebar/index.md',
  ...
  feedbackPublicEntry: 'vendor/semi-design/packages/semi-ui/feedback/index.tsx',
  feedbackFoundation: 'vendor/semi-design/packages/semi-foundation/feedback/foundation.ts',
  feedbackFoundationConstants: 'vendor/semi-design/packages/semi-foundation/feedback/constants.ts',
  feedbackFoundationStyle: 'vendor/semi-design/packages/semi-foundation/feedback/feedback.scss',
  feedbackDocumentation: 'vendor/semi-design/content/feedback/feedback/index.md',
...
export const PARITY_SCENARIOS = [
  ...
  },
  {
    ...
    targets: [
      {
        id: 'json-viewer-main',
        selector: '[data-parity-target="json-viewer-main"]',
        computedStyleProperties: [
          'backgroundColor',
          'boxSizing',
          'color',
      ...
      },
      {
        ...
        selector: '.json-viewer-scenario__main .semi-json-viewer-content-container',
        computedStyleProperties: ['height', 'left', 'overflowX', 'overflowY', 'position', 'width'],
      },
      {
        id: 'json-viewer-line',
        selector: '.json-viewer-scenario__main .semi-json-viewer-view-line:first-child',
        computedStyleProperties: [
          'fontFamily',
          'fontSize',
          'height',
      ...
      {
        id: 'json-viewer-custom',
        selector: '[data-parity-target="json-viewer-custom"]',
        computedStyleProperties: [
          'backgroundColor',
          'boxSizing',
          'color',
  ...
  },
  {
    ...
    targets: [
      {
        id: 'ai-chat-input-main',
        selector: '[data-parity-target="ai-chat-input-main"] .semi-aiChatInput',
        computedStyleProperties: [
          'backgroundColor',
          'borderBottomColor',
      ...
      {
        id: 'ai-chat-input-editor',
        selector: '[data-parity-target="ai-chat-input-main"] .ProseMirror',
        computedStyleProperties: ['fontFamily', 'fontSize', 'lineHeight', 'minHeight', 'outline'],
      },
      {
        id: 'ai-chat-input-footer',
        selector: '[data-parity-target="ai-chat-input-main"] .semi-aiChatInput-footer',
        computedStyleProperties: ['alignItems', 'display', 'height', 'justifyContent'],
      },
      {
        id: 'ai-chat-input-send',
        selector: '[data-parity-target="ai-chat-input-main"] .semi-aiChatInput-footer-action-send',
        computedStyleProperties: [
          'alignItems',
          'borderRadius',
          'display',
  ...
  },
  {
    ...
    targets: [
      {
        id: 'chat-message',
        selector: '.chat-scenario .semi-chat-chatBox:first-child',
        computedStyleProperties: [
          'columnGap',
          'display',
          'flexDirection',
      ...
      {
        id: 'chat-user-content',
        selector: '.chat-scenario .semi-chat-chatBox-content-user',
        computedStyleProperties: [
          'backgroundColor',
          'borderRadius',
          'boxSizing',
      ...
      {
        id: 'chat-input',
        selector: '.chat-scenario .semi-chat-inputBox-container',
        computedStyleProperties: [
          'alignItems',
          'borderBottomColor',
          'borderBottomWidth',
      ...
      {
        id: 'chat-root',
        selector: '.chat-scenario .semi-chat',
        computedStyleProperties: [
          'boxSizing',
          'display',
          'flexDirection',
    ...
    targets: [
      {
        ...
        selector: '.sidebar-scenario .semi-sidebar-container',
        computedStyleProperties: [
          'backgroundColor',
          'borderLeftColor',
          'borderLeftWidth',
      ...
      {
        id: 'sidebar-header',
        selector: '.sidebar-scenario .semi-sidebar-container-header',
        computedStyleProperties: [
          'alignItems',
          'borderBottomColor',
          'borderBottomWidth',
      ...
      {
        id: 'sidebar-options',
        selector: '.sidebar-scenario .semi-sidebar-options',
        computedStyleProperties: [
          'borderRightColor',
          'borderRightWidth',
          'display',
      ...
      {
        id: 'sidebar-collapse',
        selector: '.sidebar-scenario .semi-sidebar-collapse .semi-collapse-item',
        computedStyleProperties: [
          'backgroundColor',
          'borderBottomLeftRadius',
          'borderBottomWidth',
  ...
  },
  {
    ...
    targets: [
      {
        id: 'feedback-emoji-container',
        selector: '[data-parity-target="feedback-basic"] .semi-feedback-emoji-container',
        computedStyleProperties: ['display', 'justifyContent', 'marginBottom', 'marginTop'],
      },
      {
        id: 'feedback-emoji-item',
        selector: '[data-parity-target="feedback-basic"] .semi-feedback-emoji-item:nth-child(1)',
        computedStyleProperties: ['cursor', 'fontSize', 'height', 'lineHeight', 'width'],
      },
      {
        id: 'feedback-footer',
        selector: '[data-parity-target="feedback-basic"] .semi-feedback-footer',
        computedStyleProperties: ['display', 'gap', 'justifyContent'],
      },
    ],
  },
  {
