...
function renderSvg(props: IconSvgProps): VNode {
  return h(
    ...
    [
      h(
        'path',
        { d: 'M10.5 1.5a1.5 1.5 0 0 1 3 0v1a1.5 1.5 0 0 1-3 0v-1Z', fill: 'currentColor' },
        undefined,
      ),
      h(
        'path',
        { d: 'M10.5 21.5a1.5 1.5 0 0 1 3 0v1a1.5 1.5 0 0 1-3 0v-1Z', fill: 'currentColor' },
        undefined,
      ),
      h(
        'path',
      ...
      h(
        'path',
        { d: 'M2.5 10.5a1.5 1.5 0 0 1 0 3h-1a1.5 1.5 0 0 1 0-3h1Z', fill: 'currentColor' },
        undefined,
      ),
      h(
        'path',
      ...
      h('path', { d: 'M12 19a7 7 0 1 0 0-14 7 7 0 0 0 0 14Z', fill: 'currentColor' }, undefined),
    ],
  );
}

export default convertIcon(renderSvg, 'sun');
