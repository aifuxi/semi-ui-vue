...
function renderSvg(props: IconSvgProps): VNode {
  return h(
    ...
    [
      ...
      h('path', { d: 'm12 16 4.5-4.5A4.5 4.5 0 0 1 12 16Z', fill: 'currentColor' }, undefined),
      h(
        'path',
        {
      ...
      h('path', { d: 'M8 21a1 1 0 1 0 0 2h8a1 1 0 1 0 0-2H8Z', fill: 'currentColor' }, undefined),
    ],
  );
}

export default convertIcon(renderSvg, 'microphone_off');
