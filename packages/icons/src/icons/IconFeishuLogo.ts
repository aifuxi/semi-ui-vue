...
function renderSvg(props: IconSvgProps): VNode {
  return h(
    ...
    [
      ...
      h('path', { d: 'm20.57 14.2.01-.02.04-.07-.05.08Z', fill: 'currentColor' }, undefined),
      h(
        'path',
        {
      ...
      h('path', { d: 'M20.8 13.78v-.02l.01-.01s0 .02-.02.03Z', fill: 'currentColor' }, undefined),
      h(
        'path',
        {
...
export default convertIcon(renderSvg, 'feishu_logo');
