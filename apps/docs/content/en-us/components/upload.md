---
title: 'Upload'
description: 'File selection upload'
locale: 'en-US'
slug: 'upload'
category: 'input'
order: 53
...
::demo-block{demo="upload/en-US/Example1" title="Basic usage"}
::

## v-model and manual upload

::demo-block{demo="upload/en-US/Example2" title="v-model and manual upload"}
::
...
`showClear`, `showRetry`, `showUploadList`, and `showTooltip` default to `true`; an explicit `false` always wins. See [alignment.md](https://github.com/aifuxi/semi-ui-vue/blob/master/docs/components/upload/alignment.md) for evidence and [react-to-vue.md](#react-vue) for migration details.
