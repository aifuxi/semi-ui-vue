...
Examples 1–15 use byte-identical local copies of the pinned Figma/Docs icons under `/demos/table/`, preserving their 64×64 intrinsic size. Later examples still use the existing local illustration and are outside this acceptance slice.
