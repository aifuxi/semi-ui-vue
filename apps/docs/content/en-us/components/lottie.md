...
description: 'Display Lottie animation on the web page'
locale: 'en-US'
slug: 'lottie'
category: 'plus'
order: 34
englishTitle: 'Lottie Animation'
icon: 'doc-lottie'
upstream: 'plus/lottie'
---
...
::demo-block{demo="lottie/en-US/Example1" title="Control the animation instance"}
::
...
See the [alignment matrix](https://github.com/aifuxi/semi-ui-vue/blob/master/docs/components/lottie/alignment.md) for the complete API, DOM, lifecycle, visual, and
deviation evidence, and [React → Vue](#react-vue) for migration details.
