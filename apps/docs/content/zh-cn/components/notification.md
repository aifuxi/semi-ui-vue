...
::demo-block{demo="notification/zh-CN/Example1" title="局部上下文"}
::
...
完整证据、事件顺序和差异裁决见 [对齐矩阵](https://github.com/aifuxi/semi-ui-vue/blob/master/docs/components/notification/alignment.md) 与 [React → Vue 迁移](#react-vue)。
