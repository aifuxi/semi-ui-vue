...
::demo-block{demo="lottie/zh-CN/Example1" title="控制动画实例"}
::
...
完整 API、DOM、生命周期、视觉与 deviation 证据见 [对齐矩阵](https://github.com/aifuxi/semi-ui-vue/blob/master/docs/components/lottie/alignment.md)，React
迁移见 [React → Vue](#react-vue)。
