---
title: '表单'
description: '`Form` 管理字段值、错误、触碰状态、校验、提交与重置。实现基线固定为 Semi Design v2.102.0；公开接口使用 Vue 原生 props、emits、slots 与 composable。'
locale: 'zh-CN'
slug: 'form'
category: 'input'
order: 40
...
::demo-block{demo="form/zh-CN/Example1" title="基础用法"}
::
...
::demo-block{demo="form/zh-CN/Example2" title="外部表单与数组字段"}
::
...
完整源码证据、默认值、事件顺序、DOM/ARIA、SSR 与浏览器验收见 [alignment.md](https://github.com/aifuxi/semi-ui-vue/blob/master/docs/components/form/alignment.md)，React 迁移见 [react-to-vue.md](#react-vue)。
