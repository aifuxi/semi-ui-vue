    ...
    <div style="display: flex; flex-direction: column; gap: 8px; margin-bottom: 8px">
      <span
        ...
        <RadioGroup v-model="mode" type="button"
          ><Radio value="bubble">气泡</Radio><Radio value="noBubble">非气泡</Radio
          ><Radio value="userBubble">用户会话气泡</Radio></RadioGroup
        ></span
      >
      <span
        >会话布局方式
        <RadioGroup v-model="align" type="button"
          ...
          ><Radio value="leftAlign">左对齐</Radio></RadioGroup
        ></span
      >
    </div>
    <Chat
      ...
      :mode="mode"
      :align="align"
      :upload-tip-props="{ content: '自定义上传按钮提示信息' }"
