...
import { responseToMessage } from '@aifuxi/semi-ui-vue/ai-chat-dialogue';
import { RESPONSE_DATA } from './adapterData';
const chats = ref<Message[]>([responseToMessage(RESPONSE_DATA)]);
</script>
<template>
