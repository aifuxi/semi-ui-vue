...
import { chatCompletionToMessage } from '@aifuxi/semi-ui-vue/ai-chat-dialogue';
import { CHAT_COMPLETION_DATA } from './adapterData';
const chats = ref<Message[]>(chatCompletionToMessage(CHAT_COMPLETION_DATA));
</script>
<template>
