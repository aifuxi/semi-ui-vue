...
import { Col } from '@aifuxi/semi-ui-vue/grid';
...
<template>
  ...
  <Row :style="rowStyle" :gutter="16">
    <Col :span="12">
      ...
      <Input prefix="Prefix" show-clear></Input>
      ...
      <Input show-clear
        ><template #suffix
          ><Typography.Text strong type="secondary" :style="{ margin: '0 8px' }"
      ...
      <TextArea placeholder="Input something" :max-count="100"></TextArea>

      <br />
      <br />

      <div :style="flexStyle">
        <Switch :style="{ marginRight: '8px' }" :default-checked="true"></Switch>

        <Switch :style="{ marginRight: '8px' }"></Switch>

        <Switch disabled :default-checked="true" :style="{ marginRight: '8px' }"></Switch>
      </div>

      <div :style="flexStyle">
        <Checkbox :style="{ marginRight: '8px' }" default-checked>Checkbox</Checkbox>

        <Checkbox :style="{ marginRight: '8px' }" disabled default-checked
          >Disabled Checkbox</Checkbox
        >

        <Checkbox :style="{ marginRight: '8px' }" disabled>Disabled Checkbox</Checkbox>
      </div>

      <div :style="{ ...flexStyle, marginBottom: '0px' }">
        <Radio :style="{ marginRight: '8px' }" default-checked>Radio</Radio>

        <Radio :style="{ marginRight: '8px' }" disabled default-checked>Disabled Radio</Radio>

        <Radio :style="{ marginRight: '8px' }" disabled>Disabled Radio</Radio>
      </div>
    </Col>
    ...
    <Col :span="12">
      <DatePicker
        :style="{ width: '100%' }"
        @change="(date: unknown, dateString: unknown) => console.log(dateString)"
      ></DatePicker>
      ...
      <Select :style="{ width: '100%' }" placeholder="Select-single">
        ...
        <Select.Option value="pipixia" disabled>Pipixia</Select.Option>
      ...
      <Cascader :style="{ width: '100%' }" :tree-data="treeData" placeholder="Cascader"></Cascader>
    </Col>
  </Row>
</template>
