...
const roleConfig = {
  ...
  assistant: new Map([
    ['PM', { name: '产品经理', avatar: '/demos/two.svg' }],
    ['UI', { name: '设计师', avatar: '/demos/one.svg' }],
    ['FE', { name: '前端开发', avatar: '/demos/two.svg' }],
  ]),
};
let sequence = 0;
    ...
    ><div style="display: flex; column-gap: 10px">
      ...
      >
        ...
        <AIChatInput
          ...
          default-content='我是一名<input-slot placeholder="[职业]">程序员</input-slot>，帮我实现<input-slot placeholder="[需求描述]">Multi Agent 场景下的聊天应用</input-slot>需求'
      ...
      >
        ...
        >
          <div style="font-size: 16px; line-height: 22px; font-weight: 600">
            {{ sideBarContent?.type === 'annotation' ? '参考资料' : '产物列表' }}
          </div>
          <Button
            theme="borderless"
            type="tertiary"
