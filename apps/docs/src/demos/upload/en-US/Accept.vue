...
<template>
  <Upload
    ...
    ><Button theme="light"
      ><template #icon><IconUpload /></template>Upload images</Button
    ></Upload
  ><Upload
    action="/demonstration-only"
    :custom-request="simulateUpload"
    ...
    style="margin-bottom: 12px"
    ><Button theme="light"
      ><template #icon><IconUpload /></template>Upload videos</Button
    ></Upload
  ><Upload
    action="/demonstration-only"
    :custom-request="simulateUpload"
    ...
    style="margin-bottom: 12px"
    ><Button theme="light"
      ><template #icon><IconUpload /></template>PDF, PNG, JPEG</Button
    ></Upload
  >
</template>
