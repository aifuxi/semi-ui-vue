    ...
    annotations: [
      {
        ...
        detail:
          'A comprehensive, easy-to-use, and high-quality modern enterprise-level application UI solution',
        img: '/demos/photo.svg',
      },
      {
        order: 2,
    ...
    annotations: [
      {
        ...
        url: '/demos/photo.svg',
        detail:
          'Semi Design provides a wealth of design resources to help designers and developers collaborate efficiently. Whether you are a community user or an internal ByteDance designer, you can find UI kits and Figma plugins that fit your needs.',
        logo: '/demos/one.svg',
