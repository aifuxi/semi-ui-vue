...
import CollapseScenario from './components/CollapseScenario.vue';
import CodeHighlightScenario from './components/CodeHighlightScenario.vue';
  ...
  >
    ...
    <section class="scenario-panel" aria-labelledby="scenario-title">
      ...
      <CascaderScenario
        ...
        :locale="props.locale"
      />
      <CollapseScenario v-else-if="scenario.id === 'collapse'" />
      <CodeHighlightScenario v-else-if="scenario.id === 'code-highlight'" />
